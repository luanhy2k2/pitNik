    ...
    public partial class initialization : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMessageRecipients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupMessageRecipients_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GroupMessageRecipients_GroupMessage_GroupMessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMessageRecipients_GroupMessageId",
                table: "GroupMessageRecipients",
                column: "GroupMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupMessageRecipients_UserId",
                table: "GroupMessageRecipients",
                column: "UserId");
